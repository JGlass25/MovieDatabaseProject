                  ...
                  <div class="col-lg-10 align-self-baseline">
                      <form action="search.php" method="post">
                          <div class="input-group">
                              ...
                              <input type="text" name="search" id="title" class="form-control form-control-lg" placeholder="Search by title..." aria-autocomplete="both" aria-haspopup="false" autocapitalize="off" autocomplete="off" autocorrect="off" autofocus="" role="combobox" spellcheck="false" onkeydown="searchq()">

                              <span class="input-group-btn">
                                  <button type="submit"  name="go" class="btn-secondary btn-block btn-lg ">
      ...
      <div class="album py-5 bg-light">
        ...
        <?php
          ...
          if (isset($_POST['search'])) {
              ...
              $sql = "SELECT * FROM paper WHERE title LIKE '%$searchq%'";
