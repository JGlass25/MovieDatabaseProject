                          ...
                          <div class="input-group">
                              <div class="shadow-none input-group-btn search-panel">
                                  ...
                                  <ul class="dropdown-menu" role="menu">
                                    <li><a href="update.php">Actor</a></li>
                                    <li>&#10003; Director</li>
                                  </ul>
                              </div>
      ...
      <div class="album py-5 bg-light">
        ...
        <?php
          ...
          if (isset($_POST['search'])) {
              ...
              $sql = "SELECT Director_id, CONCAT(first_name, ' ', last_name) as director, gender, DATE_FORMAT(birthdate, '%b %e, %Y') as birthdate,
                        CASE
                            WHEN deathdate IS null THEN deathdate
                            ELSE DATE_FORMAT(deathdate, '%b %e, %Y')
                        END AS deathdate from Director WHERE (last_name LIKE '$searchq%' OR first_name LIKE '$searchq%' OR CONCAT(first_name, ' ', last_name) LIKE '$searchq%')";
              ...
              if ($result -> num_rows > 0) {
                  ...
                  while ($row = $result->fetch_assoc()) {
                      ?>
                      <tr>
                          <td> <center><?php echo $row['Director_id'] ?> </center></td>
                          ...
                          <td> <center><?php echo $row['deathdate'] ?> </center></td>
                              ...
                              <form method="post" action="dupdateRecord.php?action=update&id=<?php echo $row['Director_id']?>&date=<?php echo $ddate ?>">
